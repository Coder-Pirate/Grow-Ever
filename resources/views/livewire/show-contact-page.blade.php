                                ...
                                <div class="contact-form">
                                    <form wire:submit="submit">
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model="name" name="name" type="text" class="form-control shadow-none @error('name') is-invalid @enderror"  id="name">
                                            @error('name')
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model="number" name="number" type="number" class="form-control shadow-none @error('number') is-invalid @enderror"  id="number">
                                            @error('number')
                                            <p class="invalid-feedback">{{ $message }}</p>
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model="email" name="email" type="email" class="form-control shadow-none @error('email') is-invalid @enderror"   id="email">
                                            @error('email')
                                            <p class="invalid-feedback">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="massage" class="form-label">Write Message</label>
